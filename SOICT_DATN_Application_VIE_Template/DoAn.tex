...
\usepackage[backend=biber,style=ieee]{biblatex}  % backend=biber recommended
...
\def \TITLE{Ứng dụng di động chấm thi trắc nghiệm di động tích hợp OCR và Generative AI}
...
\setcounter{secnumdepth}{3} % Cho phép subsubsection trong report (level 3)
