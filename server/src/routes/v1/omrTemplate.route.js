...
router.route('/default').get(auth(), omrTemplateController.getDefault);
...
router.route('/:id/full').get(auth(), omrTemplateController.getFullById);

router.route('/:id/json').get(auth(), omrTemplateController.getJsonById);

router.route('/:id/duplicate').post(auth('manageOMRTemplates'), omrTemplateController.duplicate);

router.route('/:id/pdf').get(auth(), validate(omrTemplateValidation.generatePdf), omrTemplateController.generatePdf);
...
router.route('/exam/:examId').get(auth(), omrTemplateController.getByExamId);

router.route('/exam/:examId/json').get(auth(), omrTemplateController.getScanJsonByExamId);
