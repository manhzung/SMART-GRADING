...
const { userOne, userTwo, admin, teacherOne, teacherTwo } = require('./user.fixture');
...
const teacherTwoAccessToken = tokenService.generateToken(teacherTwo._id, accessTokenExpires, tokenTypes.ACCESS);
